(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))s(o);new MutationObserver(o=>{for(const u of o)if(u.type==="childList")for(const l of u.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&s(l)}).observe(document,{childList:!0,subtree:!0});function n(o){const u={};return o.integrity&&(u.integrity=o.integrity),o.referrerPolicy&&(u.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?u.credentials="include":o.crossOrigin==="anonymous"?u.credentials="omit":u.credentials="same-origin",u}function s(o){if(o.ep)return;o.ep=!0;const u=n(o);fetch(o.href,u)}})();const U=[{name:"Swampert",id:260,types:["Agua","Tierra"],image:"https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/260.png",location:"Inicial (Mudkip)",role:"Tanque Mixto / Líder",item:"Arena Fina",nature:"Plácida / Audaz",moves:[{name:"Surf",type:"Agua",category:"Especial"},{name:"Terremoto",type:"Tierra",category:"Físico"},{name:"Rayo Hielo",type:"Hielo",category:"Especial"},{name:"Cascada",type:"Agua",category:"Físico"}]},{name:"Gardevoir",id:282,types:["Psíquico"],image:"https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/282.png",location:"Ruta 102 (Ralts)",role:"Atacante Especial",item:"Cuchara Torcida",nature:"Modesta / Miedosa",moves:[{name:"Psíquico",type:"Psíquico",category:"Especial"},{name:"Rayo",type:"Eléctrico",category:"Especial"},{name:"Paz Mental",type:"Psíquico",category:"Estado"},{name:"Bola Sombra",type:"Fantasma",category:"Físico"}]},{name:"Breloom",id:286,types:["Planta","Lucha"],image:"https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/286.png",location:"Bosque Petalia (Shroomish)",role:"Físico / Espora",item:"Semilla Milagro",nature:"Firme / Alegre",moves:[{name:"Espora",type:"Planta",category:"Estado"},{name:"Gancho Alto",type:"Lucha",category:"Físico"},{name:"Giga Drenado",type:"Planta",category:"Especial"},{name:"Corpulencia",type:"Lucha",category:"Estado"}]},{name:"Manectric",id:310,types:["Eléctrico"],image:"https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/310.png",location:"Ruta 110 (Electrike)",role:"Velocidad Especial",item:"Imán",nature:"Modesta / Miedosa",moves:[{name:"Rayo",type:"Eléctrico",category:"Especial"},{name:"Mordisco",type:"Siniestro",category:"Especial"},{name:"Onda Trueno",type:"Eléctrico",category:"Estado"},{name:"Ataque Rápido",type:"Normal",category:"Físico"}]},{name:"Flygon",id:330,types:["Tierra","Dragón"],image:"https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/330.png",location:"Ruta 111 (Trapinch)",role:"Atacante Físico",item:"Arena Fina",nature:"Firme / Alegre",moves:[{name:"Terremoto",type:"Tierra",category:"Físico"},{name:"Avalancha",type:"Roca",category:"Físico"},{name:"Garra Dragón",type:"Dragón",category:"Especial"},{name:"Vuelo",type:"Volador",category:"Físico"}]},{name:"Salamence",id:373,types:["Dragón","Volador"],image:"https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/373.png",location:"Cascada Meteoro (Bagon)",role:"Potencia Bruta",item:"Colmillo Dragón",nature:"Pícara / Ingenua",moves:[{name:"Vuelo",type:"Volador",category:"Físico"},{name:"Garra Dragón",type:"Dragón",category:"Especial"},{name:"Lanzallamas",type:"Fuego",category:"Especial"},{name:"Demolición",type:"Lucha",category:"Físico"}]}],W={Normal:"Normal",Fire:"Fuego",Water:"Agua",Grass:"Planta",Electric:"Eléctrico",Ice:"Hielo",Fighting:"Lucha",Poison:"Veneno",Ground:"Tierra",Flying:"Volador",Psychic:"Psíquico",Bug:"Bicho",Rock:"Roca",Ghost:"Fantasma",Dragon:"Dragón",Steel:"Acero",Dark:"Siniestro"};function M(r){if(!r)return"";const a=r.charAt(0).toUpperCase()+r.slice(1).toLowerCase();return W[a]||r}function re(){const r=document.getElementById("team");r&&(r.innerHTML=`
  ...
  `;const a=document.getElementById("natures-grid"),n=document.getElementById("ref-search");function s(o=""){const u=o.toLowerCase(),l=ie.filter(c=>c.name.toLowerCase().includes(u));if(l.length===0){a.innerHTML='<p style="grid-column: 1/-1; text-align: center; color: #666;">No se encontraron naturalezas.</p>';return}a.innerHTML=l.map(c=>{const g=c.plus==="-"&&c.minus==="-";return`
            <div style="
            ...
            " onmouseover="this.style.transform='translateY(-2px)'; this.style.borderColor='var(--ray-green)'" 
               ...
               <h4 style="font-size: 1.1rem; margin-bottom: 0.75rem; color: #fff;">${c.name}</h4>
  ...
  `;const a=document.getElementById("drop-zone"),n=document.getElementById("file-input"),s=document.getElementById("scanner-results"),o=document.getElementById("error-msg");a.addEventListener("click",()=>n.click()),a.addEventListener("dragover",m=>{m.preventDefault(),a.style.background="rgba(0, 255, 127, 0.2)",a.style.borderColor="#fff"}),a.addEventListener("dragleave",m=>{m.preventDefault(),a.style.background="rgba(0, 20, 0, 0.5)",a.style.borderColor="var(--ray-green)"}),a.addEventListener("drop",m=>{m.preventDefault(),a.style.background="rgba(0, 20, 0, 0.5)",a.style.borderColor="var(--ray-green)",m.dataTransfer.files.length&&u(m.dataTransfer.files[0])}),n.addEventListener("change",m=>{m.target.files.length&&u(m.target.files[0])});function u(m){o.innerText="",s.innerHTML="<p style='color:var(--ray-green); width:100%; text-align:center;'>Analizando estructura binaria...</p>";const e=new FileReader;e.onload=t=>{try{const p=t.target.result,d=new pe(p).parse();if(d.error)throw new Error(d.error);l(d.team)}catch(p){console.error(p),o.innerText="Error: "+p.message,s.innerHTML=""}},e.readAsArrayBuffer(m)}function l(m){s.innerHTML=m.map(e=>{if(e.speciesId===0)return"";const t=e.isEgg?"https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/egg.png":`https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/${e.isShiny?"shiny/":""}${e.nationalId}.png`;return`
        <div class="emulator-box" style="text-align:left; position:relative; overflow:hidden; border: 1px solid ${e.isShiny?"#ffd700":"rgba(255,255,255,0.1)"};">
            ...
            <div style="display:grid; grid-template-columns: 1fr 1fr; gap:0.5rem; font-size:0.85rem; color:#ccc;">
                <div>
                    ...
                    PS: <span style="${c(e.ivs.hp)}">${e.ivs.hp}</span><br>
                    Ataque: <span style="${c(e.ivs.atk)}">${e.ivs.atk}</span><br>
                    Defensa: <span style="${c(e.ivs.def)}">${e.ivs.def}</span><br>
                    Velocid: <span style="${c(e.ivs.spd)}">${e.ivs.spd}</span><br>
                    At.Esp: <span style="${c(e.ivs.spa)}">${e.ivs.spa}</span><br>
                    Df.Esp: <span style="${c(e.ivs.spdef)}">${e.ivs.spdef}</span>
                </div>
                <div>
  ...
  `,k.length===0)try{k=(await(await fetch("https://pokeapi.co/api/v2/pokemon?limit=1000")).json()).results}catch(s){console.error("Error fetching pokemon",s)}const a=document.getElementById("poke-search"),n=document.getElementById("search-suggestions");a.addEventListener("input",s=>{const o=s.target.value.toLowerCase();if(n.innerHTML="",o.length<2){n.style.display="none";return}const u=k.filter(l=>l.name.includes(o)).slice(0,8);u.length>0?(n.style.display="block",n.innerHTML=u.map(l=>{const g=`https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/${l.url.split("/")[6]}.png`;return`
              ...
              `}).join(""),document.querySelectorAll(".suggestion-item").forEach(l=>{l.addEventListener("click",()=>{a.value=l.textContent.trim(),n.style.display="none",fe(l.dataset.url)}),l.addEventListener("mouseenter",()=>l.style.background="var(--glass-shine)"),l.addEventListener("mouseleave",()=>l.style.background="transparent")})):n.style.display="none"})}async function fe(r){const a=document.getElementById("calc-results"),n=document.getElementById("enemy-header");a.style.display="grid",n.innerHTML='<div style="padding:2rem;">Cargando datos...</div>';try{const o=await(await fetch(r)).json(),u=o.types.map(l=>{const c=l.type.name.charAt(0).toUpperCase()+l.type.name.slice(1);return W[c]||c});he(u,o.name.toUpperCase(),o.sprites.front_default)}catch(s){console.error(s),n.innerHTML="Error cargando detalles."}}function he(r,a,n){const s=document.getElementById("calc-results"),o=document.getElementById("enemy-header"),u=document.getElementById("weakness-info"),l=document.getElementById("team-analysis");s.style.display="grid";let c="";n&&(c+=`<img src="${n}" style="width:100px; height:100px; animation: float 3s infinite ease-in-out;">`),c+=`<h2 style="margin:0.25rem 0; color:var(--text-main); font-size:1.4rem; text-shadow:0 0 10px rgba(45,158,109,0.5);">${a}</h2>`,c+=`<div class="poke-types" style="justify-content:center; gap:0.25rem;">
      ${r.map(i=>`<span class="type-pill type-${i.toLowerCase()}">${M(i)}</span>`).join("")}
    </div>`,o.innerHTML=c;const g={};x.forEach(i=>{let d=1;r.forEach(h=>{const f=x.indexOf(i),y=x.indexOf(h);f!==-1&&y!==-1&&(d*=B[f][y])}),d!==1&&(g[i]=d)});const m=Object.entries(g).filter(([i,d])=>d>1).sort((i,d)=>d[1]-i[1]),e=Object.entries(g).filter(([i,d])=>d<1).sort((i,d)=>i[1]-d[1]);let t='<div style="display:grid; gap:1rem;">';m.length>0?(t+=`<div><h4 style="color:#ff6b6b; margin-bottom:0.5rem; text-align:center; font-size:0.9rem;">⚠️ Muy Débil A</h4>
        <div style="display:flex; flex-wrap:wrap; gap:0.25rem; justify-content:center;">`,t+=m.map(([i,d])=>`
            <span class="type-pill type-${i.toLowerCase()}">
                ${M(i)} <strong style="color:white; margin-left:2px;">x${d}</strong>
            </span>
        ...
        <div style="display:flex; flex-wrap:wrap; gap:0.25rem; justify-content:center;">`,t+=e.map(([i,d])=>`
            <span class="type-pill type-${i.toLowerCase()}" style="opacity:0.9;">
                ${M(i)} x${d}
            </span>
        `).join(""),t+="</div></div>"):t+='<div style="text-align:center;"><span style="color:var(--text-muted); font-size:0.8rem;">Daño neutro</span></div>',t+="</div>",u.innerHTML=t;const p=U.map(i=>{let d={name:"Ninguno",mod:0};i.moves.forEach(f=>{if(f.category==="Status")return;let y=1;r.forEach(C=>{const b=x.indexOf(f.type),v=x.indexOf(C);b!==-1&&v!==-1&&(y*=B[b][v])}),i.types.includes(f.type)&&(y*=1.5),y>d.mod&&(d={name:f.name,mod:y,type:f.type})});let h=0;return r.forEach(f=>{let y=1;i.types.forEach(C=>{const b=x.indexOf(f),v=x.indexOf(C);b!==-1&&v!==-1&&(y*=B[b][v])}),y>h&&(h=y)}),{member:i,bestMove:d,maxReceiveMod:h}});p.sort((i,d)=>d.bestMove.mod-i.bestMove.mod),l.innerHTML=p.map(i=>{let d="#a0a0a0";return i.bestMove.mod>=2&&(d="#2d9e6d"),i.maxReceiveMod>=2&&(d="#ff4081"),`
        <div class="recommendation-card" style="border-color:${d}; padding:0.5rem; margin-top:0;">
